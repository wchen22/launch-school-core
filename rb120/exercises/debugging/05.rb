...
# No class constant for File. There are only FORMAT constants for the subclasses. Could add a class constant for the File superclass, OR if there isn't one, we could call self.class::format
