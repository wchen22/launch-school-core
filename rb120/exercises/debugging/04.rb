...
class EmployeeManagementSystem
  ...
  attr_accessor :employees # This prevents the list from being viewed (or edited) in its raw form with full serial numbers from outside by calling something like apple.employees
end 
