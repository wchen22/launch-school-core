...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: wilsonchen
--
...
ALTER TABLE public.weather OWNER TO wilsonchen;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: wilsonchen
--
