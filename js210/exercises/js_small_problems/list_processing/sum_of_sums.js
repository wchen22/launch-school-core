...
function sumOfSums(array) {
  let sumArray = (array) => array.reduce((sum, number) => sum + number);
  
  let subsequenceSums = array.map((number, index) => sumArray(array.slice(0, index + 1)));
  
  return sumArray(subsequenceSums);
}
