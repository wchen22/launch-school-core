...
function updateCart(name, amount) {
  // amount = amount || 1; // when amount is 0, since it is falsy, amount will return the last evaluated operand which is 1. rather than 0ing out the pencils, we change it from 2 to 1.

  if (amount === undefined) amount = 1; // or actually better; set default parameter to 1
